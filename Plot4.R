...
#4. Transforming the Date and Time vars from characters into objects of type Date and POSIXlt:
...
#5. Initiating composite plot with many graphs:
par(mfrow=c(2,2))
#6. Calling basic plot function & render the 4 distinct plots that form the graph:
with(subpower_con,{
